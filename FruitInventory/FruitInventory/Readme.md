...
### FruitInventory.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [FruitInventory.Sample.csproj](../FruitInventory.Sample/FruitInventory.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### FruitInventory.Tests
