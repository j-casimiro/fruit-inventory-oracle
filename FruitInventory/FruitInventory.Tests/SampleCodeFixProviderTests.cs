...
using Xunit;
using Verifier =
    Microsoft.CodeAnalysis.CSharp.Testing.XUnit.CodeFixVerifier<FruitInventory.SampleSyntaxAnalyzer,
        FruitInventory.SampleCodeFixProvider>;

namespace FruitInventory.Tests;
